...
// class CreateAccount {
// public static BankAccount createNewBankAccount(long accountNumber, String
// ownerName, BigDecimal balance) {
...
// BankAccount bankAccount = CreateAccount.createNewBankAccount("Vesper Lind",
// new BigDecimal("0.0"));
// BankAccount bankAccount2 = CreateAccount.createNewBankAccount("Celine ", new
// BigDecimal("0.0"));
